...
**[Maude for Claude](https://github.com/john-broadway/maude-for-claude)** — Claude's partner inside Claude Code. He writes the code; she notices. A plugin that walks your workspace each session, watches Claude, and runs the gate before something irreversible. Markdown, JSON, and bash — no daemon. v0.1.6 shipped 2026-05-08. Apache 2.0.
